...
import static edu.poly.shopbangiay.view.HoaDonUI.getBillingandShippingCell;
...
//        int index = cbxTT.getSelectedIndex();
    ...
    private void initComponents() {
        ...
        lbName.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        lbName.setForeground(new java.awt.Color(255, 0, 0));
        lbName.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbName.setText("Chu Văn Quang");
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 234, Short.MAX_VALUE)
        ...
        tblSP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã", "Tên", "Loại", "NSX", "Size", "Đơn giá"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        btnInHD.setBackground(new java.awt.Color(255, 255, 204));
        btnInHD.setText("Thanh toán và in hóa đơn");
    ...
    public void showPanel(Component form){
        removeAll();
        add(form);
        repaint();
        revalidate();
...
//        jPanel14.revalidate();
    ...
    private void btnThemHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemHDActionPerformed
        ...
        nguoiDung.setId(Auth.user.getId());
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        ...
        if (checkTT()) {
            if (checkForm()) {
                ...
                JOptionPane.showMessageDialog(this, "Thanh toán thành công\n" + "Tiền thừa: " + formatter.format(Math.abs(thanhTien() - khachTT())) + "VNĐ");
                clearFrom();
                loadHD(locHD());
                loadGH(cthdService.getCTHDByMaHD(txtMaHD.getText()));
    ...
    private void btnInHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInHDActionPerformed
        ...
        if (checkTT()) {
            if (checkForm()) {
                ...
                clearFrom();
                loadHD(locHD());
                loadGH(cthdService.getCTHDByMaHD(""));
                loadSP(ctspService.getList());
            }
        }
